...
[cols=".^2a,3a"]
|===
|image::_@fatbuildr:overview:fatbuildr_logo_large.svg[Fatbuildr,275,120,xref=_@fatbuildr:overview:start.adoc]
...
[cols=".^2a,3a"]
|===
|image::beta@racksdb:overview:racksdb_logo_large.svg[RacksDB,275,120,xref=beta@racksdb:overview:start.adoc]
...
❯ xref:beta@racksdb:overview:start.adoc[Read the documentation]
|===
****
